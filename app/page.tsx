            ...
            <FadeUp delay={0.18}>
              <div style={{ background: W, boxShadow: "0 4px 32px rgba(0,0,0,0.07)", display: "flex", flexDirection: "column", transition: "transform .2s, box-shadow .2s" }}
                ...
                <div style={{ padding: "36px 40px 40px", display: "flex", flexDirection: "column", gap: 20, flex: 1 }}>
                  ...
                  <a href="https://premiumadvisoryservices.com" target="_blank" rel="noreferrer" style={{ fontFamily: P, fontWeight: 700, fontSize: 11, letterSpacing: "0.16em", textTransform: "uppercase", background: BLUE, color: W, padding: "16px 28px", textDecoration: "none", alignSelf: "flex-start", marginTop: "auto" }}>
                    View Listing →
                  </a>
                </div>
              </div>
